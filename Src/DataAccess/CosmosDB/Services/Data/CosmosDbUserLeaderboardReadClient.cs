// <copyright file="CosmosDbUserLeaderboardReadClient.cs" company="Microsoft">
...
namespace CosmosDB.Services.Data
{
    ...
    public class CosmosDbUserLeaderboardReadClient : CosmosDbClient, ICosmosDbUserLeaderboardReadClient
    {
        private CosmosDbDatabaseName databaseName;
        private CosmosDbCollectionName containerName;
        private int resultPerPage = 25;

        public CosmosDbUserLeaderboardReadClient(
